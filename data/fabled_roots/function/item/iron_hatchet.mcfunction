...
execute as @e[type=!#fabled_roots:not_damageable_by_throwables,distance=..128] unless predicate fabled_roots:entity/has_no_hurttime run damage @s 2.5 minecraft:player_attack by @p[tag=fabled_roots.threw_hatchet]
