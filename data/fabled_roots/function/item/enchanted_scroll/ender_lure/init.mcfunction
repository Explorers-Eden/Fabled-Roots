...
execute if score @s fabled_roots.exp.player.level matches ..29 run return run function fabled_roots:item/enchanted_scroll/cancel {scroll:"ender_lure"}
...
function fabled_roots:item/enchanted_scroll/ender_lure/exec with storage fabled_roots:temp enchanted_scroll