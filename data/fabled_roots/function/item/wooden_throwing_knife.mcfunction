...
execute as @e[type=!#fabled_roots:non_living,distance=..128] unless predicate fabled_roots:entity/has_no_hurttime run damage @s 0.25 minecraft:player_attack by @p[tag=fabled_roots.threw_knife]
