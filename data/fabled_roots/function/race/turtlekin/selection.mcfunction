...
function fabled_roots:selection_msg {race:"turtlekin",race_cap:"Turtlekin"}

tag @s add fabled_roots.turtlekin
team join fabled_roots.turtlekin
tag @s add fabled_roots.has_race

execute store result storage fabled_roots:temp fabled_roots.player_size float 0.01 run random value 85..110
