...
execute if predicate eden:entity/is_crouching run effect give @s minecraft:night_vision 15 0 true
execute if predicate eden:entity/is_crouching run particle dust{color:[0.910,0.855,0.855],scale:1} ~ ~ ~ .5 .5 .5 1 5 normal