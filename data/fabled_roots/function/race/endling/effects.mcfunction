...
execute if predicate eden:entity/is_crouching run effect give @e[distance=0.1..3] minecraft:levitation 2 0 false
execute if predicate eden:entity/is_crouching run particle dust{color:[0.365,0.227,0.608],scale:1} ~ ~ ~ .5 .5 .5 1 5 normal