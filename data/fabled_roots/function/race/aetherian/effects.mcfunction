...
execute if predicate eden:entity/is_crouching run effect give @s minecraft:levitation 2 0 true
execute if predicate eden:entity/is_crouching run particle dust{color:[0.831,0.945,1.000],scale:1} ~ ~ ~ .5 .5 .5 1 5 normal