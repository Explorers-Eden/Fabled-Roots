...
execute if score $model fabled_roots.technical matches 1..2 store result storage eden:temp fabled_roots.npc.id int 1 run random value 1..12
execute if score $model fabled_roots.technical matches 3..4 store result storage eden:temp fabled_roots.npc.id int 1 run random value 1..18

data modify storage eden:temp fabled_roots.npc.race set value "moonshroud"
data modify storage eden:temp fabled_roots.npc.race_cap set value "Moonshroud"

execute store result storage eden:temp fabled_roots.npc.size float 0.01 run random value 85..100
