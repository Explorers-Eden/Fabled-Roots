...
$execute as @e[type=#fabled_roots:rancher_effect,distance=..16] on leasher if predicate {"type":"minecraft:random_chance","chance":0.025} run experience add @s $(exp) points
