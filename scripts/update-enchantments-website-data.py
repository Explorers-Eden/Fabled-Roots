...
SOURCE_LANG = Path("assets/fabled_roots/lang/en_us.json")
SOURCE_ENCHANTMENTS_DIR = Path("data/fabled_roots/enchantment")
...
DATAPACK_INFO = {
    "name": "Fabled Roots",
    "url": "https://modrinth.com/datapack/fabled-roots"
}
...
def build_entry_from_wiki(enchant_id: str, enchant_json):
    enchant_key = f"enchantment.fabled_roots.{enchant_id}"
    wiki_key = f"wiki.fabled_roots.{enchant_id}"
